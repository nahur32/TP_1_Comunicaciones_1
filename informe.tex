...
\input{librerias} %llama al archivo donde estan todas las librerias include


%%encabezado
\rhead{\begin{picture}(0,0)	\put(-22,0) {\includegraphics[height=1cm]{caratula/logounsl.png}} \end{picture}}
\lhead{\begin{picture}(0,0)	\put(0,0) {\includegraphics[height=1cm]{caratula/logo_depto.jpg}} \end{picture}}
...
%   \tableofcontents %Para el indice
    \include{Parte_teorica/actividad_1.tex} %llama los otros archivos .tex
    \include{Parte_teorica/actividad_2.tex}
 %   \include{actividad3}
 %   \include{conclusion}
